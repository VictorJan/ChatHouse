from chathouse.rest.users.identified.keyring.controller.get.strategy import GetIdentifiedUserKeyringStrategy
...
In this case the Controller is the - [Get][IdentifiedUserKeyring]Controller.
[Get] - method GET.
[IdentifiedUserKeyring] - REST endpoint - /users/<identification>/keyring.
'''
GetIdentifiedUserKeyringController=Controller(GetIdentifiedUserKeyringStrategy())